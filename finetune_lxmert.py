...
from datasets import delete_word,MatchDataset_v2
...
def train(opt):
    ...
    mylxmert = MyLxmertFinetune.from_pretrained(opt.pretrain_model_path  , output_dim = 13)
